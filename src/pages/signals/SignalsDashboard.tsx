...
const QuickStat: React.FC<QuickStatProps> = ({ 
  ...
  const accentColors = {
    ...
    slate: "from-slate-500/20 to-slate-500/5 border-dark-border/50",
  };
  ...
  <button
    ...
    className={`
      ...
      ${active
        ...
        : "text-gray-400 hover:text-white hover:bg-dark-elevated/70"
      }
    `}
  >
    <span className="flex items-center gap-2">
      ...
      {count !== undefined && (
        <span className={`
          ...
          ${active ? "bg-white/20" : "bg-dark-surface"}
        `}>
          {count}
        </span>
      )}
    ...
    <div className="min-h-screen bg-dark-base">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          {/* Tabs */}
          <div className="flex items-center gap-2 p-1 bg-dark-elevated rounded-2xl border border-dark-border">
            <TabButton
        ...
        {displayedLoading && filteredSignals.length === 0 ? (
          <div className="flex items-center justify-center py-20">
            <div className="text-center">
              <Spinner size="lg" />
              <p className="text-sm text-gray-500 mt-4">Loading signals...</p>
            </div>
          </div>
        ) : displayedError ? (
          ...
          displayedError.toLowerCase().includes('upgrade') ? (
            ...
            <Card className="p-8 text-center bg-dark-elevated border-dark-border">
              ...
              <button
                ...
                className="px-4 py-2 bg-dark-elevated hover:bg-dark-surface text-white rounded-lg text-sm transition-colors"
              >
                Try Again
              </button>
            </Card>
