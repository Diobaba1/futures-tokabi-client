...
export const SymbolSearchPage: React.FC = () => {
  ...
  if (viewMode === 'detail' && selectedSearchDetail) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-dark-base to-dark-base py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <button
              onClick={() => setViewMode('history')}
              className="inline-flex items-center gap-2 px-4 py-2 text-gray-300 hover:text-white bg-dark-elevated hover:bg-gray-700/50 border border-dark-border rounded-lg transition-all duration-200 mb-4 backdrop-blur-sm hover:shadow-lg"
            >
              <ArrowLeftIcon className="w-4 h-4" />
              Back to History
            </button>

            <div className="bg-dark-elevated backdrop-blur-sm rounded-xl shadow-lg border border-dark-border p-6">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <button className="inline-flex items-center gap-2 px-4 py-2 text-gray-300 bg-gray-700/50 hover:bg-gray-600/50 border border-dark-border rounded-lg transition-all duration-200 hover:shadow-lg">
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-dark-base to-dark-base py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          {/* History Panel */}
          <div className="bg-dark-elevated/30 backdrop-blur-sm rounded-2xl shadow-2xl border border-dark-border p-6">
            <SearchHistoryPanel
