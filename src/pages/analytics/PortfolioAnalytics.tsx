...
const PortfolioAnalyticsComponent: React.FC = () => {
  ...
  useEffect(() => {
    const handleUpdate = (e: CustomEvent<PortfolioUpdateMessage>) => {
      try {
        ...
        if (
          ...
          typeof total_wallet_balance !== "number" ||
          typeof total_unrealized_profit !== "number" ||
    ...
    window.addEventListener(
      "websocketError",
      handleWebSocketError as EventListener
    );
        ...
        balance: wsUpdate
          ? {
              ...
              unrealized_pnl_percent:
                wsUpdate.total_wallet_balance > 0
                  ? (wsUpdate.total_unrealized_profit /
                      wsUpdate.total_wallet_balance) *
                    100
                  : 0,
            }
          : portfolio.balance,
  ...
  const { balance, performance, risk, recent_trades } = combinedPortfolio ||
    portfolio || { balance: {}, performance: {}, risk: {}, recent_trades: [] };
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-red-400/80 text-sm">
                Real-time updates unavailable. Data will refresh every 30
                seconds.
        ...
        <div className="bg-gray-800/40 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center py-3 border-b border-gray-700/50">
              ...
              <span
                className={`font-semibold ${getPnLColor(
                  balance.unrealized_pnl_percent || 0
                )}`}
              >
                {formatPercent(balance.unrealized_pnl_percent || 0)}
              </span>
              ...
              recent_trades.map((trade: TradeSummary) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <div
                      className={`font-bold ${getPnLColor(trade.pnl_usd || 0)}`}
                    >
      ...
      <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 rounded-2xl p-6 border border-yellow-500/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="text-center p-4 bg-black/20 rounded-xl">
            ...
            <div className="text-xs text-gray-400 mt-1">
              {(risk.current_drawdown_percent || 0) > 10
                ? "Monitor Closely"
                : "Healthy"}
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-yellow-400/80 text-xs mt-1">
                WebSocket Status: {websocketStatus} | Reconnect attempts:{" "}
                {websocketService.getReconnectAttempts()}
              </p>
            </div>
          </div>
