...
const FAQPage: React.FC = () => {
  ...
  const faqs: FAQItem[] = [
    ...
    { category: 'Account & Billing', question: 'What subscription plans are available?', answer: 'We offer three tiers: Alpha (basic signals and Telegram alerts), Edge (priority signals, advanced analytics, and API access), and Zenith (personalized support, exclusive insights, and direct analyst access). Visit our pricing page for current rates.' },
