...
const FAQPage: React.FC = () => {
  ...
  const faqs: FAQItem[] = [
    ...
    { category: 'Signals & Trading', question: 'Do you execute trades automatically?', answer: 'No, Tokabi is an intelligence platform, not an automated trading bot. We provide the analysis and signals—you maintain full control over your execution decisions. This approach helps you stay engaged and learn while trading.' },
