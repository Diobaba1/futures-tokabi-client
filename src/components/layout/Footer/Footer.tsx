    ...
    <footer className="bg-gray-950 border-t border-gray-800/30">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <p className="text-center text-xs text-gray-600 leading-relaxed">
          Tokabi is a market intelligence software platform. We are not investment advisors. Trading involves substantial risk of loss. Past performance is not indicative of future results.
        </p>
      </div>
